...
resource "google_compute_instance" "nifi-ca" {
    ...
    metadata_startup_script =   <<EOF
        ...
        then 
            ...
            su nifi -c 'export PATH=$PATH:/usr/lib/jvm/jdk/bin && cd /home/nifi && ${var.nifi-path}/nifi-toolkit-${var.nifi-toolkit-version}/bin/tls-toolkit.sh server -c ${var.nifi-ca-hostname} -t ${var.ca-token} &'
