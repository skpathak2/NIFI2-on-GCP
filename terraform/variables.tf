...
variable "nifi-toolkit-version" {
    description = "NIFI Toolkit binaries version"
    type        = string
    default     = "1.15.3"
}
...
variable "password" {
 ...
 variable "jdkpackage" {
     description = ""
     type = string
     default = "OpenJDK21U-jdk_x64_linux_hotspot_21.0.5_11.tar.gz"
 }
